...
# Makes variables for the folder with the format and usage reports (report_folder) and the date (formatted YYYY-MM-DD),
# which is part of the summary report name.
