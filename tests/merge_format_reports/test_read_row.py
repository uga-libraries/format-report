...
class MyTestCase(unittest.TestCase):
    ...
    def test_aip_attribute_error(self):
        ...
        self.assertEqual(format_row, expected_format, "Problem with test for aip: value error, report_row")
    ...
    def test_aip_one(self):
        ...
        self.assertEqual(format_row, expected_format, "Problem with test for aip: one, report_row")
    ...
    def test_aip_three(self):
        ...
        self.assertEqual(format_row, expected_format, "Problem with test for aip: three, report_row")
    ...
    def test_blank(self):
        ...
        self.assertEqual(format_row, expected_format, "Problem with test for blank, report_row")
    ...
    def test_no_blank(self):
        ...
        expected_format = ["bmac", "836", "17005.995", "video", "Quicktime", "QuickTime|for_test_version|x-fmt/384",
                           ...
                           "File is encoded in the following wrapper:ProRes 422 HQ"]
        self.assertEqual(format_row, expected_format, "Problem with test for no blank, report_row")
