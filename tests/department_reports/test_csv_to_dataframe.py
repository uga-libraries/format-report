...
class MyTestCase(unittest.TestCase):
    ...
    def test_multi_groups(self):
        ...
        expected = [["Group", "Collection", "AIP", "Format_Identification", "Format_Name", "Format_Version",
                    ...
                    ["hargrett", "harg-0000", "harg-0000-web-202007-0001", "WARC|NO VALUE|fmt/289", "WARC",
                     "NO VALUE", "https://www.nationalarchives.gov.uk/PRONOM/fmt/289", "Low Risk", "Retain"],
                    ["hargrett", "harg-0000", "harg-0000-web-202007-0002", "WARC|NO VALUE|fmt/289", "WARC",
                     "NO VALUE", "https://www.nationalarchives.gov.uk/PRONOM/fmt/289", "Low Risk", "Retain"],
                    ["bmac", "peabody", "bmac_51021enr-1a", "Wave|NO VALUE|NO VALUE", "Wave",
                     "NO VALUE", "NO VALUE", "Low Risk", "Retain"],
                    ["dlg", "zhj_tecc", "zhj_tecc_rml-ohp-001", "Waveform Audio|NO VALUE|NO VALUE",
                     "Waveform Audio", "NO VALUE", "NO VALUE", "Low Risk", "Retain"]]
    ...
    def test_puid_all(self):
        ...
        expected = [["Group", "Collection", "AIP", "Format_Identification", "Format_Name", "Format_Version",
                     "PRONOM_URL", "2023_NARA_Risk_Level", "2023_NARA_Proposed_Preservation_Plan"],
                    ["hargrett", "harg-ms3786", "harg-ms3786er0013", "JPEG EXIF|2.1|x-fmt/390", "JPEG EXIF", "2.1",
                     "https://www.nationalarchives.gov.uk/PRONOM/x-fmt/390", "Low Risk", "Retain"],
                    ["hargrett", "harg-ms3786", "harg-ms3786er0016", "JPEG EXIF|2.1|x-fmt/390", "JPEG EXIF", "2.1",
                     "https://www.nationalarchives.gov.uk/PRONOM/x-fmt/390", "Low Risk", "Retain"],
    ...
    def test_puid_mix(self):
        ...
        expected = [["Group", "Collection", "AIP", "Format_Identification", "Format_Name", "Format_Version",
                    ...
                    ["dlg", "guan_ms40", "dlg_turningpoint_harg0040-001-002",
                     "Tagged Image File Format|NO VALUE|NO VALUE", "Tagged Image File Format", "NO VALUE", "NO VALUE",
    ...
    def test_version_all(self):
        ...
        expected = [["Group", "Collection", "AIP", "Format_Identification", "Format_Name", "Format_Version",
                    ...
                    ["russell", "rbrl459", "rbrl-459-er-000030", "Microsoft Works Database for DOS|1.05|fmt/169",
                     "Microsoft Works Database for DOS", "1.05", "https://www.nationalarchives.gov.uk/PRONOM/fmt/169",
                     "Moderate Risk", "Transform to CSV"],
    ...
    def test_version_none(self):
        ...
        expected = [["Group", "Collection", "AIP", "Format_Identification", "Format_Name", "Format_Version",
                    ...
                    ["russell", "rbrl377", "rbrl-377-er-000001", "SWF|NO VALUE|NO VALUE",
