...
class MyTestCase(unittest.TestCase):
    ...
    def test_aip_multiple(self):
        ...
        rows = [["hargrett", "har-ua20-002", "har-ua20-002_0002_metadata", "xml (Moderate Risk)", "xml",
                 "NO VALUE", "NO VALUE", "Moderate Risk", "Retain", "Moderate Risk", "Unchanged"],
                ["hargrett", "har-ua20-002", "har-ua20-002_0002_metadata", "Plain text (Low Risk)", "Plain text",
                 "NO VALUE", "NO VALUE", "Low Risk", "Retain", "Low Risk", "Unchanged"],
                ["hargrett", "harg-0000", "harg-0000-web-202007-0002", "GZIP Format (High Risk)", "GZIP Format",
                 "NO VALUE", "NO VALUE", "High Risk", "Retain", "High Risk", "Unchanged"],
                ["hargrett", "harg-0000", "harg-0000-web-202007-0002", "TIFF EXIF (Low Risk)", "TIFF EXIF",
                 "NO VALUE", "NO VALUE", "Low Risk", "Retain", "Low Risk", "Unchanged"],
                ["hargrett", "harg-ms3770", "harg-ms3770er0002", "Plain text (Low Risk)", "Plain text",
                 "NO VALUE", "NO VALUE", "Low Risk", "Retain", "Low Risk", "Unchanged"],
                ["hargrett", "harg-ms3770", "harg-ms3770er0002", "MPEG-PS (Moderate Risk)", "MPEG-PS",
                 "NO VALUE", "NO VALUE", "Moderate Risk", "Retain", "Moderate Risk", "Unchanged"],
                ["hargrett", "harg-ms3770", "harg-ms3770er0002", "MPEG video (Moderate Risk)", "MPEG video",
                 "NO VALUE", "NO VALUE", "Moderate Risk", "Retain", "Moderate Risk", "Unchanged"],
                ["hargrett", "harg-ms3786", "harg-ms3786er0020", "MPEG-PS (Moderate Risk)", "MPEG-PS",
                 "NO VALUE", "NO VALUE", "Moderate Risk", "Retain", "Moderate Risk", "Unchanged"],
                ["hargrett", "harg-ms3786", "harg-ms3786er0020", "MPEG video (Moderate Risk)", "MPEG video",
                 "NO VALUE", "NO VALUE", "Moderate Risk", "Retain", "Moderate Risk", "Unchanged"],
                ["hargrett", "harg-ms3786", "harg-ms3786er0020", "Quicktime video (No Match)", "Quicktime video",
                 "NO VALUE", "NO VALUE", "No Match", "Retain", "No Match", "Unchanged"],
                ["hargrett", "harg-ms3786", "harg-ms3786er0020", "SWF (No Match)", "SWF",
                 "NO VALUE", "NO VALUE", "No Match", "Retain", "No Match", "Unchanged"]]
        df = make_df(rows)
        ...
        self.assertEqual(result, expected,
                         "Problem with test for one AIP, multiple formats")
    ...
    def test_aip_one(self):
        ...
        """
        # Makes a dataframe to use as test input.
        rows = [["hargrett", "har-ua20-002", "har-ua20-002_0001_metadata", "xml (Moderate Risk)", "xml",
                 "NO VALUE", "NO VALUE", "Moderate Risk", "Retain", "Moderate Risk", "Unchanged"],
                ["hargrett", "harg-0000", "harg-0000-web-202007-0001", "GZIP Format (High Risk)", "GZIP Format",
                 "NO VALUE", "NO VALUE", "High Risk", "Retain", "High Risk", "Unchanged"],
                ["hargrett", "harg-ms3770", "harg-ms3770er0002", "Plain text (Low Risk)", "Plain text",
                 "NO VALUE", "NO VALUE", "Low Risk", "Retain", "Low Risk", "Unchanged"],
                ["hargrett", "harg-ms3786", "harg-ms3786er0007", "NEF EXIF (No Match)", "NEF EXIF",
                 "NO VALUE", "NO VALUE", "No Match", "Retain", "No Match", "Unchanged"]]
        df = make_df(rows)
    ...
    def test_aips_multiple(self):
        ...
        """
        # Makes a dataframe to use as test input.
        rows = [["hargrett", "harg-ms3770", "harg-ms3770er0002", "xml (Moderate Risk)", "xml",
                 "NO VALUE", "NO VALUE", "Moderate Risk", "Retain", "Moderate Risk", "Unchanged"],
                ["hargrett", "harg-ms3770", "harg-ms3770er0002", "Plain text (Low Risk)", "Plain text",
                 "NO VALUE", "NO VALUE", "Low Risk", "Retain", "Low Risk", "Unchanged"],
                ["hargrett", "harg-ms3770", "harg-ms3770er0001", "Plain text (Low Risk)", "Plain text",
                 "NO VALUE", "NO VALUE", "Low Risk", "Retain", "Low Risk", "Unchanged"],
                ["hargrett", "harg-ms3770", "harg-ms3770er0001", "JPEG EXIF 1.2 (Low Risk)", "JPEG EXIF",
                 "1.2", "NO VALUE", "Low Risk", "Retain", "Low Risk", "Unchanged"],
                ["hargrett", "harg-ms3796", "harg-ms3796er0007", "xml (Moderate Risk)", "xml",
                 "NO VALUE", "NO VALUE", "Moderate Risk", "Retain", "Moderate Risk", "Unchanged"],
                ["hargrett", "harg-ms3796", "harg-ms3796er0007", "MPEG video (Moderate Risk)", "MPEG video",
                 "NO VALUE", "NO VALUE", "Moderate Risk", "Retain", "Moderate Risk", "Unchanged"],
                ["hargrett", "harg-ms3796", "harg-ms3796er0025", "JPEG EXIF 1.2 (Low Risk)", "JPEG EXIF",
                 "1.2", "NO VALUE", "Low Risk", "Retain", "Low Risk", "Unchanged"],
                ["hargrett", "harg-ms3796", "harg-ms3796er0025", "TIFF EXIF (Low Risk)", "TIFF EXIF",
                 "NO VALUE", "NO VALUE", "Low Risk", "Retain", "Low Risk", "Unchanged"],
                ["hargrett", "harg-ms3796", "harg-ms3796er0025", "Plain text (Low Risk)", "Plain text",
                 "NO VALUE", "NO VALUE", "Low Risk", "Retain", "Low Risk", "Unchanged"]]
        df = make_df(rows)
    ...
    def test_aips_one(self):
        ...
        """
        # Makes a dataframe to use as test input.
        rows = [["hargrett", "harg-ms3786", "harg-ms3786er0012", "xml (Moderate Risk)", "xml",
                 "NO VALUE", "NO VALUE", "Moderate Risk", "Retain", "Moderate Risk", "Unchanged"],
                ["hargrett", "harg-ms3770", "harg-ms3770er0001", "GZIP Format (High Risk)", "GZIP Format",
                 "NO VALUE", "NO VALUE", "High Risk", "Retain", "High Risk", "Unchanged"],
                ["hargrett", "harg-ms3770", "harg-ms3770er0002", "Plain text (Low Risk)", "Plain text",
                 "NO VALUE", "NO VALUE", "Low Risk", "Retain", "Low Risk", "Unchanged"],
                ["hargrett", "harg-ms3786", "harg-ms3786er0007", "NEF EXIF (No Match)", "NEF EXIF",
    ...
    def test_puid_duplicates(self):
        ...
        """
        # Makes a dataframe to use as test input.
        rows = [["hargrett", "harg-0000", "harg-0000-web-202007-0001", "GZIP Format (High Risk)", "GZIP Format",
                 "NO VALUE", "NO VALUE", "High Risk", "Retain", "High Risk", "Unchanged"],
                ["hargrett", "harg-0000", "harg-0000-web-202007-0001", "GZIP Format (High Risk)", "GZIP Format",
                 "NO VALUE", "https://www.nationalarchives.gov.uk/PRONOM/x-fmt/266", "High Risk", "Retain",
                 "High Risk", "Unchanged"],
                ["hargrett", "harg-ms3786", "harg-ms3786er0004", "Plain text (Low Risk)", "Plain text",
                 "NO VALUE", "NO VALUE", "Low Risk", "Retain", "Low Risk", "Unchanged"],
                ["hargrett", "harg-ms3786", "harg-ms3786er0024", "Plain text (Low Risk)", "Plain text",
                 "NO VALUE", "https://www.nationalarchives.gov.uk/PRONOM/x-fmt/266", "Plain text", "Retain",
                 "Low Risk", "Unchanged"],
                ["hargrett", "harg-ms3786", "harg-ms3786er0024", "Plain text (Low Risk)", "Low Risk",
                 "NO VALUE", "NO VALUE", "Low Risk", "Retain", "Low Risk", "Unchanged"]]
        df = make_df(rows)
